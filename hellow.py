...
def image_scale_setting():
    ...
    image_buble = pygame.transform.scale(image_buble, (180, 120))
    image_sound = pygame.transform.scale(image_sound, (180, 120))
    image_buble_missile1 = pygame.transform.scale(image_buble_missile1, (50, 50))
    image_buble_missile2 = pygame.transform.scale(image_buble_missile2, (90, 90))
    image_sound_missile1 = pygame.transform.scale(image_sound_missile1, (50, 50))
    image_sound_missile2 = pygame.transform.scale(image_sound_missile2, (90, 90))
...
def GameStart():
    ...
    while running:
        ...
        # 화면 밖으로 나간 미사일 제거
        buble_missile_list = [missile for missile in buble_missile_list if missile.x < 1280]
